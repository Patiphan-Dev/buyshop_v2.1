...
if (!preg_match('/^[a-zA-Z0-9\_]*$/', @$_GET['id'])) {
    ...
    $typeid = $connect->real_escape_string(@$_GET['id']);
}
?>
<div class="col-md-6 col-sm-12 mt-2">
    <div class="card crad_tung text-white mb-3">
        <div class="card-header"><i class="fa-solid fa-folder-plus"></i> Add Rewards - เพิ่มรางวัล</div>
        <div class="card-body mb-6">

            <div class="form-group">
                <div class="text-center pointer">
                    <img src="assets/img/game_icon/picture.png" alt="null" width="17%" id="output" onclick="click_image()">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="typegame" class="form-control" id="typegame">
                        <option value="spin" <?php if(@$_GET['g']=="spin"){ echo "selected"; } ?>>Game Spin</option>
                        <option value="roller" <?php if(@$_GET['g']=="roller"){ echo "selected"; } ?>>Game Roller</option>
                        <option value="slot" <?php if(@$_GET['g']=="slot"){ echo "selected"; } ?>>Game Slot</option> 
                    </select>
                </div>
            </div>
            <div class="form-group row">
                <div class="form-group col-md-4">
                    ...
                    <select name="typereward" class="form-control" id="typereward">
                        <option value="0">เลิอกประเภทของรางวัล</option>
                        <option value="1">เกลือ</option>
                        <option value="2">เครดิต</option>
                        <option value="3">Gif Code หรือ บัตรเติมเงิน</option> 
                    </select>
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    ...
                    <input class="form-control form-control-color" type="color" id="colorrewards" placeholder="FFCC00" value="#2D8791">
                </div>
            ...
            <div class="form-group">
                <label for="formFile" class="form-label mt-2"><i class="fa-solid fa-caret-right"></i> เปอร์เซ็นการออกรางวัล <span class="badge rounded-pill bg-info" style="font-size: 0.9rem;" id="valBox">50 %</span></label>
